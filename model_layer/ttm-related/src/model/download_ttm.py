...
def _dependency_help(import_error):
    ...
    message = (
        "Could not import IBM's TTM loader:"
        " tsfm_public.toolkit.get_model.\n"
        f"   Python executable: {sys.executable}\n"
        f"   Python version: {python_version}\n"
        "   Fix: use Python 3.11, 3.12, or 3.13,"
        " then install granite-tsfm.\n"
        "   Example:\n"
        "     deactivate\n"
...
def download_ttm_model():
    ...
    try:
        ...
        # The TTM R2 repo has several revisions; get_model selects
        # a compatible checkpoint for this context and horizon.
        model = get_model(
            MODEL_PATH,
        ...
        # Minimal sanity-check: 5 raw channels to confirm model loads.
        # Full pipeline uses 8 channels per the Architecture Diagram.
        ...
        print("2. Install IBM's TTM: python -m pip install granite-tsfm")
