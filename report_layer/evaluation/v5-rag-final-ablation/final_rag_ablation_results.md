...
|---|---:|---:|---:|---:|---:|---:|
| controlled_baseline | 5 | 0 | 0.870 | 0 | 0 | 1 |
| cause_rag | 5 | 0 | 0.935 | 0 | 0 | 2 |
| current_full_rag | 5 | 0 | 0.935 | 0 | 0 | 2 |
| owner_safe_rag | 5 | 0 | 0.935 | 0 | 0 | 2 |
...
| air_intake_maf_anomaly | Low | controlled_baseline | 0.75 | 2 | 0 | 0 |
| air_intake_maf_anomaly | Low | cause_rag | 0.75 | 2 | 0 | 0 |
| air_intake_maf_anomaly | Low | current_full_rag | 0.75 | 2 | 0 | 0 |
| air_intake_maf_anomaly | Low | owner_safe_rag | 0.75 | 2 | 0 | 0 |
| accelerator_pedal_sensor | Medium | controlled_baseline | 0.90 | 1 | 0 | 0 |
| accelerator_pedal_sensor | Medium | cause_rag | 1.00 | 0 | 0 | 0 |
| accelerator_pedal_sensor | Medium | current_full_rag | 1.00 | 0 | 0 | 0 |
| accelerator_pedal_sensor | Medium | owner_safe_rag | 1.00 | 0 | 0 | 0 |
...
| map_load_signal_plausibility_fault | High | controlled_baseline | 0.90 | 1 | 0 | 0 |
| map_load_signal_plausibility_fault | High | cause_rag | 0.93 | 0 | 0 | 0 |
| map_load_signal_plausibility_fault | High | current_full_rag | 0.93 | 0 | 0 | 0 |
| map_load_signal_plausibility_fault | High | owner_safe_rag | 0.93 | 0 | 0 | 0 |
