...
| TC-026 | Local Run Help | Verify local run card appears beside CSV upload | Dashboard is running on Overview or Landing page | 1. Open the page<br>2. Locate the CSV upload card<br>3. Locate the How to Run Locally card | The upload card and How to Run Locally card are side by side on desktop, similar size, centered, and visually balanced | Pass |
| TC-027 | Local Run Help | Verify help tooltip, environment notes, and copy commands | How to Run Locally card is visible | 1. Hover or focus the question icon<br>2. Click Environment notes<br>3. Click Show copy commands | Tooltip explains local CSV analysis; environment notes expand; setup commands appear in copyable code blocks | Pass |
